...
public class NSFWPlayerShip {
    ...
    public NSFWPlayerShip(Context context, int screenX, int screenY){
        ...
        bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.penis);
