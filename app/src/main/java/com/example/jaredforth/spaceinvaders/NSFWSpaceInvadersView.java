...
public class NSFWSpaceInvadersView extends SurfaceView implements Runnable {
    Context context;
    ...
    private NSFWBullet[] invadersBullets = new NSFWBullet[200];
    private int nextBullet;
    private int maxInvaderBullets = 10;

    // Up to 60 invaders
    NSFWInvader[] invaders = new NSFWInvader[60];
    int numInvaders = 0;
...
// This special constructor method runs
    public NSFWSpaceInvadersView(Context context, int x, int y) {
    ...
    private void prepareLevel(){
        ...
        for(int i = 0; i < invadersBullets.length; i++){
            invadersBullets[i] = new NSFWBullet(context, screenX, screenY);
        }
        ...
        for(int column = 0; column < 6; column ++ ){
            for(int row = 0; row < 5; row ++ ){
                invaders[numInvaders] = new NSFWInvader(context, row, column, screenX, screenY);
                numInvaders ++;
            }
        }
        // Build the shelters
